...
/**
 * This event listener offers more coarse grained event listener methods as it
 * aggregates events for the execute* and addBatch methods.
 */
public abstract class SimpleJdbcEventListener extends JdbcEventListener {

	/**
	 * This callback method is executed before any
	 * {@link java.sql.Statement}.execute* method is invoked
	 *
	 * @param statementInformation
	 *            The meta information about the {@link java.sql.Statement} being
	 *            invoked
	 */
	...
	/**
	 * This callback method is executed before any
	 * {@link java.sql.Statement}.addBatch* method is invoked
	 *
	 * @param statementInformation
	 *            The meta information about the {@link java.sql.Statement} being
	 *            invoked
