...
public abstract class AbstractWrapper implements Wrapper, PermsProxy {
	...
	public static boolean isProxy(final Class<?> clazz) {
		return (clazz != null && PermsProxy.class.isAssignableFrom(clazz));
	}
	...
	public boolean equals(Object obj) {
		...
		// unwrap it first.
		if (obj instanceof PermsProxy) {
			obj = ((PermsProxy) obj).unwrapProxy();
		}
